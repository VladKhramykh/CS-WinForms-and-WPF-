...
namespace OOP_4_5
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void openButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (open.ShowDialog() == true)
            {
                ...
                if (File.Exists(fileName))
                {
                    ...
                    fileStream.Close();
                    lastDocList.Items.Add(fileName);
        ...
        private void saveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                ...
                using (FileStream fs = File.Create(saveFileDialog.FileName))
                {
                    ...
                    lastDocList.Items.Add(saveFileDialog.FileName);
        ...
        private void boldFontButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if ((FontWeight)selectedText.GetPropertyValue(TextElement.FontWeightProperty) == FontWeights.Bold)
        ...
        private void underlineFontButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if((FontStyle)selectedText.GetPropertyValue(TextElement.FontStyleProperty) == FontStyles.Oblique)
                selectedText.ApplyPropertyValue(TextElement.FontStyleProperty, FontStyles.Normal);                
            else
        ...
        {
            Resources.Source = new Uri("pack://application:,,,/Resourses/ENG.xaml");
        }

        private void langSwitcher_Unchecked(object sender, RoutedEventArgs e)
        {
            Resources.Source = new Uri("pack://application:,,,/Resourses/RU.xaml");
        }
        ...
        private void blueRect_MouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            DragMove();
        }
        ...
        private void lastDocList_Selected(object sender, RoutedEventArgs e)
        {
            string fileName = lastDocList.SelectedItem.ToString();
                if (File.Exists(fileName))
                {
                    TextRange textRange = new TextRange(textBox.Document.ContentStart, textBox.Document.ContentEnd);
                    FileStream fileStream = new FileStream(fileName, FileMode.OpenOrCreate);
